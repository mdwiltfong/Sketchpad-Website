...
document
  ...
  .addEventListener("click", changeBrushSize);
document
  .getElementById("brush-settings")
  .addEventListener("keydown", changeBrushSize);
...
lightSlider.oninput = function () {
  swatch3.style.backgroundColor =
    "hsl(0," + satSlider.value + "%, " + lightSlider.value + "%)";
  swatch4.style.backgroundColor =
    "hsl(240," + satSlider.value + "%, " + lightSlider.value + "%)";
  swatch5.style.backgroundColor =
    "hsl(120," + satSlider.value + "%, " + lightSlider.value + "%)";
  swatch6.style.backgroundColor =
    "hsl(39," + satSlider.value + "%, " + lightSlider.value + "%)";
  swatch7.style.backgroundColor =
    "hsl(60," + satSlider.value + "%, " + lightSlider.value + "%)";
  swatch8.style.backgroundColor =
    "hsl(330," + satSlider.value + "%," + lightSlider.value + "%)";
